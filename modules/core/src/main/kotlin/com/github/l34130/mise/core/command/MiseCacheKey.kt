...
sealed class MiseCacheKey<out T> {
    ...
    /**
     * Cache key for mise version command.
     *
     * Key format: `version:{workDir}`
     * Result type: `Result<MiseVersion>`
     *
     * Example: `version:/home/user/project`
     */
    data class Version(
        val workDir: String
    ) : MiseCacheKey<Result<MiseVersion>>() {
        override val key = "version:$workDir"
        override val progressTitle = "Detecting Mise Version"
    }
